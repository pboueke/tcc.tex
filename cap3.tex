...
monitor/                         & Rota para acesso à \textbackslash{}textit\{view\} Monitor                                                 \\ \hline
dispatch/                        & Rota para acesso à \textbackslash{}textit\{view\} Disparo                                                 \\ \hline
showroom/                        & Rota para acesso à \textbackslash{}textit\{view\} Showroom                                                \\ \hline
dispatch/update\_dispatch/       & Rota para requisição assíncrona de atualização da \textbackslash{}textit\{view\} Disparo                  \\ \hline
showroom/update\_showroom/       & Rota para requisição assíncrona de atualização da \textbackslash{}textit\{view\} Showroom                 \\ \hline
showroom/update\_showroom\_item/ & Rota para requisição assíncrona de atualização de um dos items da \textbackslash{}textit\{view\} Showroom \\ \hline
monitor/monitor\_status/         & Rota para requisição assíncrona de atualização  da \textbackslash{}textit\{view\} Monitor                 \\ \hline
monitor/process\_kill/           & Rota para requisição assíncrona de remoção do comando no arquivo \textbackslash{}textit\{crontab\}        \\ \hline
monitor/process\_start/          & Rota para requisição assíncrona de inserção do  comando no arquivo \textbackslash{}textit\{crontab\}      \\ \hline
\end{tabular}%
}
\end{table}
