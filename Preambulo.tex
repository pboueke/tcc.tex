...
\paragraph{}O trabalho aqui exposto tem como finalidade propor uma plataforma para execução de modelos de aprendizado de máquina de forma escalonada e de fácil gerência, se tratando de um sistema configurável e acessível a usuários por meio de uma interface \textit{web}. O trabalho aborda a arquitetura desse sistema e uma implementação e implantação, apresentando suas componentes, funcionamento e um protótipo para sua validação. Também são realizadas conclusões em cima do trabalho desenvolvido e são apresentados trabalhos futuros em cima da proposta exposta.
\paragraph{}
